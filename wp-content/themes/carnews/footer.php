	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3 col-sm-6 col-xs-12">
                <?php dynamic_sidebar('widget-footer-bottom-one');?>
			</div>
			<div class="col-md-3 col-sm-6 col-xs-12">
				<?php dynamic_sidebar('widget-footer-bottom-two');?>
			</div>
			<div class="col-md-3 col-sm-6 col-xs-12">
                <?php dynamic_sidebar('widget-footer-bottom-three');?>
			</div>
			<div class="col-md-3 col-sm-6 col-xs-12">
                <?php dynamic_sidebar('widget-footer-bottom-four');?>
			</div>
		</div>
	</div>
</div>
